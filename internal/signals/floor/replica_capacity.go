...
// about it, and the throughput reading the floor prices with.
type ReplicaCapacity struct {
	...
	K2Priority            capacity.K2Source // how k2 was computed
	...
	// throughput model (Estimate) can take the residency charge
